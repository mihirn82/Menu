...
public class MainActivity extends AppCompatActivity {
    ...
    public void printToLogs(View view) {
        ...
        Log.i("MainActivity.java ",menuItem1.getText().toString());

        // Find second menu item TextView and print the text to the logs
        TextView menuItem2 = (TextView) findViewById(R.id.menu_item_2);
        Log.i("MainActivity.java ",menuItem2.getText().toString());

        // Find third menu item TextView and print the text to the logs
        TextView menuItem3 = (TextView) findViewById(R.id.menu_item_3);
        Log.i("MainActivity.java ",menuItem3.getText().toString());
